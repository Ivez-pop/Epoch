    ...
    <div className="flex-1 flex flex-col items-center justify-center p-4 md:p-8">
      <div className="w-full max-w-sm mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-xs text-zinc-400">Create an account to start tracking personal activities</p>
        </div>
        ...
        <div className="rounded-2xl border border-zinc-800 bg-zinc-900/90 p-6 sm:p-8 shadow-2xl backdrop-blur-xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              <label htmlFor="confirm-password" className="block text-xs font-medium text-zinc-300 mb-1.5">
                Confirm Password
              </label>
              <input
                id="confirm-password"
